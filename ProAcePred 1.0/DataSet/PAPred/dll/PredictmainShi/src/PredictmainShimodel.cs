...
* "class{PredictmainShimodel:F:\matlabÉúÎï³ÌÐòÎÄ¼þ\ÐÂÊµÑé¶þ\libsvmread.mexw64,F:\matlabÉúÎ
* ï³ÌÐòÎÄ¼þ\ÐÂÊµÑé¶þ\libsvmwrite.mexw64,F:\matlabÉúÎï³ÌÐòÎÄ¼þ\ÐÂÊµÑé¶þ\PredictmainShi.m,F:
...
namespace PredictmainShi
{
  /// <summary>
  /// The PredictmainShimodel class provides a CLS compliant, MWArray interface to the
  ...
  /// <newpara></newpara>
  /// F:\matlabÉúÎï³ÌÐòÎÄ¼þ\ÐÂÊµÑé¶þ\PredictmainShi.m
  /// <newpara></newpara>
  ...
  /// @Version 0.0
  /// </remarks>
  public class PredictmainShimodel : IDisposable
  {
    #region Constructors
    ...
    static PredictmainShimodel()
    {
      if (MWMCR.MCRAppInitialized)
      {
        ...
        string ctfFileName = MCRComponentState.MCC_PredictmainShi_name_data + ".ctf";
        ...
        mcr= new MWMCR(MCRComponentState.MCC_PredictmainShi_name_data,
                       MCRComponentState.MCC_PredictmainShi_root_data,
                       MCRComponentState.MCC_PredictmainShi_public_data,
                       MCRComponentState.MCC_PredictmainShi_session_data,
                       MCRComponentState.MCC_PredictmainShi_matlabpath_data,
                       MCRComponentState.MCC_PredictmainShi_classpath_data,
                       MCRComponentState.MCC_PredictmainShi_libpath_data,
                       MCRComponentState.MCC_PredictmainShi_mcr_application_options,
                       MCRComponentState.MCC_PredictmainShi_mcr_runtime_options,
                       MCRComponentState.MCC_PredictmainShi_mcr_pref_dir,
                       MCRComponentState.MCC_PredictmainShi_set_warning_state,
    ...
    /// <summary>
    /// Constructs a new instance of the PredictmainShimodel class.
    /// </summary>
    public PredictmainShimodel()
    {
    }
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the PredictmainShi
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public MWArray PredictmainShi()
    {
      return mcr.EvaluateFunction("PredictmainShi", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the PredictmainShi
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PredictmainShi(MWArray proteinsequence)
    {
      return mcr.EvaluateFunction("PredictmainShi", proteinsequence);
    }


    /// <summary>
    /// Provides a single output, 2-input MWArrayinterface to the PredictmainShi
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PredictmainShi(MWArray proteinsequence, MWArray Specificity)
    {
      return mcr.EvaluateFunction("PredictmainShi", proteinsequence, Specificity);
    }


    /// <summary>
    /// Provides the standard 0-input MWArray interface to the PredictmainShi M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM²âÊÔº¯Êý
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainShi(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "PredictmainShi", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the PredictmainShi M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM²âÊÔº¯Êý
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainShi(int numArgsOut, MWArray proteinsequence)
    {
      return mcr.EvaluateFunction(numArgsOut, "PredictmainShi", proteinsequence);
    }


    /// <summary>
    /// Provides the standard 2-input MWArray interface to the PredictmainShi M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM²âÊÔº¯Êý
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainShi(int numArgsOut, MWArray proteinsequence, MWArray 
                              Specificity)
    {
      return mcr.EvaluateFunction(numArgsOut, "PredictmainShi", proteinsequence, Specificity);
    }


    /// <summary>
    /// Provides an interface for the PredictmainShi function in which the input and
    /// output
    /// arguments are specified as an array of MWArrays.
    /// </summary>
    /// <remarks>
    ...
    /// <param name= "argsIn">Array of MWArray input arguments</param>
    ///
    public void PredictmainShi(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("PredictmainShi", numArgsOut, ref argsOut, argsIn);
    }
