...
namespace PredictmainJie
{
  /// <summary>
  /// The PredictmainJiemodel class provides a CLS compliant, MWArray interface to the
  ...
  public class PredictmainJiemodel : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the PredictmainJie
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public MWArray PredictmainJie()
    {
      return mcr.EvaluateFunction("PredictmainJie", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the PredictmainJie
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PredictmainJie(MWArray proteinsequence)
    {
    ...
    /// <summary>
    /// Provides a single output, 2-input MWArrayinterface to the PredictmainJie
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PredictmainJie(MWArray proteinsequence, MWArray Specificity)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the PredictmainJie M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM²âÊÔº¯Êý
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainJie(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "PredictmainJie", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the PredictmainJie M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM²âÊÔº¯Êý
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainJie(int numArgsOut, MWArray proteinsequence)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input MWArray interface to the PredictmainJie M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM²âÊÔº¯Êý
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainJie(int numArgsOut, MWArray proteinsequence, MWArray 
                              Specificity)
    {
    ...
    /// <summary>
    /// Provides an interface for the PredictmainJie function in which the input and
    /// output
    /// arguments are specified as an array of MWArrays.
    /// </summary>
    /// <remarks>
    ...
    /// <param name= "argsIn">Array of MWArray input arguments</param>
    ///
    public void PredictmainJie(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("PredictmainJie", numArgsOut, ref argsOut, argsIn);
    }
