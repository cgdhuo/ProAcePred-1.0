...
namespace PredictmainGuNative
{
  /// <summary>
  /// The PredictmainGumodel class provides a CLS compliant, Object (native) interface to
  ...
  public class PredictmainGumodel : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input Objectinterface to the PredictmainGu
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public Object PredictmainGu()
    {
      return mcr.EvaluateFunction("PredictmainGu", new Object[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input Objectinterface to the PredictmainGu
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object PredictmainGu(Object proteinsequence)
    {
    ...
    /// <summary>
    /// Provides a single output, 2-input Objectinterface to the PredictmainGu
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An Object containing the first output argument.</returns>
    ///
    public Object PredictmainGu(Object proteinsequence, Object Specificity)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the PredictmainGu M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM测试函数
    ...
    /// arguments.</returns>
    ///
    public Object[] PredictmainGu(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "PredictmainGu", new Object[]{});
    }


    /// <summary>
    /// Provides the standard 1-input Object interface to the PredictmainGu M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM测试函数
    ...
    /// arguments.</returns>
    ///
    public Object[] PredictmainGu(int numArgsOut, Object proteinsequence)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input Object interface to the PredictmainGu M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM测试函数
    ...
    /// arguments.</returns>
    ///
    public Object[] PredictmainGu(int numArgsOut, Object proteinsequence, Object 
                            Specificity)
    {
