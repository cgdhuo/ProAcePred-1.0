...
namespace PredictmainDa
{
  /// <summary>
  /// The PredictmainDamodel class provides a CLS compliant, MWArray interface to the
  ...
  public class PredictmainDamodel : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the PredictmainDa
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    ///
    public MWArray PredictmainDa()
    {
      return mcr.EvaluateFunction("PredictmainDa", new MWArray[]{});
    }


    /// <summary>
    /// Provides a single output, 1-input MWArrayinterface to the PredictmainDa
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PredictmainDa(MWArray proteinsequence)
    {
    ...
    /// <summary>
    /// Provides a single output, 2-input MWArrayinterface to the PredictmainDa
    /// M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    /// <returns>An MWArray containing the first output argument.</returns>
    ///
    public MWArray PredictmainDa(MWArray proteinsequence, MWArray Specificity)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input MWArray interface to the PredictmainDa M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM测试函数
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainDa(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "PredictmainDa", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 1-input MWArray interface to the PredictmainDa M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM测试函数
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainDa(int numArgsOut, MWArray proteinsequence)
    {
    ...
    /// <summary>
    /// Provides the standard 2-input MWArray interface to the PredictmainDa M-function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// SVM测试函数
    ...
    /// arguments.</returns>
    ///
    public MWArray[] PredictmainDa(int numArgsOut, MWArray proteinsequence, MWArray 
                             Specificity)
    {
    ...
    /// <summary>
    /// Provides an interface for the PredictmainDa function in which the input and
    /// output
    /// arguments are specified as an array of MWArrays.
    /// </summary>
    /// <remarks>
    ...
    /// <param name= "argsIn">Array of MWArray input arguments</param>
    ///
    public void PredictmainDa(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("PredictmainDa", numArgsOut, ref argsOut, argsIn);
    }
